        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              >
                Здравствуйте, меня зовут Ара Микаелян.
                <br />
                Я психолог и специалист в области психического здоровья,
                специализирующийся на индивидуальном консультировании,
                психологической поддержке, а также разработке и реализации
                программ по психообразованию.
                <br />
                Tакже являюсь фасилитатором ретритных групп, создавая
                безопасную, конфиденциальную и поддерживающую среду, в которой
                участники получают возможность углубить связь со своими
                внутренними процессами и восстановить внутренние ресурсы.
                <br />
                Кроме того, активно вовлечён в международные молодёжные
                программы, направленные на развитие мягких навыков (soft
                skills), социальную и культурную адаптацию, профессиональную
                ориентацию, укрепление лидерских качеств и личностное развитие
                молодых людей.
              </p>
