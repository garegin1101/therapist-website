        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center md:text-left">
              ...
              >
                Ողջույն, ես Արա Միքայելյանն եմ։
                <br />
                Դիպլոմավորված հոգեբան և հոգեկան առողջության մասնագետ եմ՝
                մասնագիտացած անհատական խորհրդատվության, հոգեբանական աջակցության,
                ինչպես նաև հոգեկրթական ծրագրերի մշակման և իրականացման
                ոլորտներում։
                <br />
                Հանդիսանում եմ նաև ռեթրիթային խմբերի ֆասիլիտատոր՝ ստեղծելով
                անվտանգ, կոնֆիդենցիալ և աջակցող միջավայր, որտեղ մասնակիցները
                հնարավորություն են ստանում խորացնելու կապն իրենց ներքին
                գործընթացների հետ և վերականգնելու ներքին ռեսուրսները։
                <br />
                Ակտիվորեն ներգրավված եմ միջազգային երիտասարդական ծրագրերում,
                որոնք ուղղված են երիտասարդների փափուկ հմտությունների (soft
                skills) զարգացմանը, սոցիալական և մշակութային ադապտացիային,
                մասնագիտական կողմնորոշմանը, առաջնորդական կարողությունների
                ամրապնդմանը և անձնային զարգացմանը։
              </p>
